...
namespace KunstSchuleWandsbek
{
    public class CharacterMovement : MonoBehaviour
    {
        ...
        {
            isGrounded = Physics2D.OverlapBox(gameObject.transform.position + groundcheckBoxPosition,
                groundcheckBoxSize, 0, groundLayer);
        ...
        {
            Gizmos.DrawWireCube(gameObject.transform.position + groundcheckBoxPosition,
                groundcheckBoxSize + new Vector3(0, 0, 0));
        }
    }
}
